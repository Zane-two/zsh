...
alias wall="cp /home/john/snap/wonderwall/35/.local/share/ktechpit/WonderWall/download/* ~/Pictures/Wallpaper"
alias p="paru -S"
...
alias fzfp="fd -t f | fzf --reverse --preview 'head -n 100 {}'"
